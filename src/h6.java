...
public class h6 {
    public static void main(String[] args) {
        ...
        int kolmellaJaolliset = laskekolmellaJaolliset(lukija);
        ...
        System.out.println("Kolmella Jaolliset: " + kolmellaJaolliset);
    ...
    //Metodi kolmella jaolliset
    public static int laskekolmellaJaolliset(Scanner lukija) {
        ...
        while (true) {
            ...
            if (luku == 0) {
                break; //Lopetetaan jos 0
            }

            if (luku > 0 && luku % 3 == 0) {
                kolmellaJaolliset += luku;
            }
        }
